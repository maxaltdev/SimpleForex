...
Selling points and goals:

* Modern (latest Java features, conventions, best practices, etc.)
* Mostly functional-style API (`Stream`, `Optional`, immutability by default, etc.)
* Follows KISS
